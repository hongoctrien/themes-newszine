	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group">
				<div class="span4">{LANG.key_title}</div>
	  			<div class="span8"><input type="text" name="q" value="{KEY}" class="form-control" id="key"/></div>
			</div>
			
			<div class="form-group">
				<div class="span4">{LANG.type_title}</div>
	  			<div class="span8">
			...
			<div class="form-group">
				<div class="span4">{LANG.search_cat}</div>
	  			<div class="span8">
			...
			<div class="form-group form-inline">
				<div class="span4">{LANG.from_date}</div>
	  			<div class="span8"><input class="datepicker form-control" name="to_date" value="{TO_DATE}" style="width:120px; display: inline" maxlength="10" type="text"/></div>
			</div>
			
			<div class="form-group form-inline">
				<div class="span4">{LANG.to_date}</div>
	  			<div class="span8"><input class="datepicker form-control" name="from_date" value="{FROM_DATE}" style="width: 120px; display: inline" maxlength="10" type="text" /></div>
			</div>
			
			<div class="form-group form-inline">
				<div class="span4 text-right">&nbsp;</div>
	  			<div class="span8"><input type="submit" class="btn btn-primary" value="{LANG.search_title}"/></div>
			</div>
