...
<form id="frm" role="form" action="{EDITINFO_FORM}" method="post" enctype="multipart/form-data" class="form-tooltip m-bottom">
	<!-- BEGIN: error -->
	...
	<div class="form-group">
		<label for="nv_username_iavim" class="span-3 control-label">{LANG.account}<span class="text-danger"> (*)</span>:</label>
		<div class="span-9">
			...
			<input type="text" class="form-control required" disabled="disabled" name="username" value="{DATA.username}" id="nv_username_iavim" maxlength="{NICK_MAXLENGTH}"  placeholder="{LANG.account}"/>
			<!-- END: username_no_change -->
		</div>
	</div>
	<div class="form-group">
		<label for="nv_email_iavim" class="span-3 control-label">{LANG.email}<span class="text-danger"> (*)</span>:</label>
		<div class="span-9">
			<!-- BEGIN: email_change -->
	...
	<div class="form-group">
		<label for="full_name" class="span-3 control-label">{LANG.name}:</label>
		<div class="span-9">
	...
	<div class="form-group">
		<label for="gender" class="span-3 control-label">{LANG.gender}:</label>
		<div class="span-9">
	...
	<div class="form-group">
		<label for="avatar" class="span-3 control-label">{LANG.avata}:</label>
		<div class="span-9">
			<!-- BEGIN: photo -->
			...
			<div id="change-photo">
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button class="btn btn-default" style="margin-top: -8px;" type="button" id="btn_upload" data-toggle="tooltip" data-placement="right" title="{LANG.avata_pagetitle}"> <em class="fa fa-folder-open-o fa-fix">&nbsp;</em></button>
					</span>
				</div>
			</div>
		</div>
	...
	<div class="form-group">
		<label for="birthday" class="span-3 control-label">{LANG.birthday}:</label>
		<div class="span-9">
			<div class="input-group">
				<input type="text" class="form-control datepicker" id="birthday" name="birthday" value="{DATA.birthday}" readonly="readonly">
				<span class="input-group-btn">
					<button class="btn btn-default" style="margin-top: -8px;" type="button" id="birthday-btn"> <em class="fa fa-calendar fa-fix">&nbsp;</em></button>
				</span>
			</div>
		</div>
	</div>
	<div class="form-group">
		<label for="view_mail" class="span-3 control-label">{LANG.showmail}:</label>
		<div class="span-9">
	...
	<!-- BEGIN: loop -->
	<div class="form-group">
		<label class="span-3 control-label" data-toggle="tooltip" data-placement="right" title="{FIELD.description}">{FIELD.title}<!-- BEGIN: required --><span class="text-danger"> (*)</span><!-- END: required -->:</label>
		<div class="span-9">
			<!-- BEGIN: textbox -->
